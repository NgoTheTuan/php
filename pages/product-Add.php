<?php
		if(isset($_REQUEST['btnGhiLai'])){
			...
			$query = "INSERT INTO products (Ma_cafe,Ten_cafe,Trong_luong,Don_gia) ";
			$query .= " VALUES('$ma_cafe','$ten_cafe','$trong_luong','$don_gia')";

			if(mysqli_query($conn, $query)){
				echo "<script> location.href='index.php?go=products-list'; </script>";
			}else{
				$err = "Lỗi thêm mới:" . $query;
			}
		}
	?>
...
<section class="container" >
		...
		<form action="" method="post" style="text-align:left">
			<div class="form-group">
                ...
                <input type="text" class="form-control" id="ma_cafe" name="ma_cafe" >
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="ten_cafe" name="ten_cafe" >
			</div>
            <div class="form-group">
                <label for="trong_luong" class="form-label">
                       Trọng lượng
                </label>
                <input type="text" class="form-control" id="trong_luong" name="trong_luong" >
			</div>
			<div class="form-group">
